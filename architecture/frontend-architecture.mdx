...
- **Molecules** — small combinations of atoms: `CommentForm`, `FilterDropdown`, `ProjectCard`, `NotificationItem`, `Breadcrumb`
- **Organisms** — larger, feature-level components: `IssueBoard`, `IssueTable`, `Sidebar`, `NewIssueModal`, `DashboardVisuals`, `SettingsSidebar`
